...
# Modèles Pydantic pour la visualisation complète des patients
class PatientFullViewModel(BaseModel):
    name: str
    age: int
    gender: str
    id: str
...
async def view_patients(
    request: Request, name: Optional[str] = None, patient_id: Optional[str] = None
):
